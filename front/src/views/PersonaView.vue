<template>
  <v-container style="padding: 50px;">
    ...
    <v-data-table :items="personas" :headers="headers" class="elevation-1">
      ...
      <template #item.creativity="{ item }">
        {{ (item.creativity * 100).toFixed(0) }}%
      </template>
    ...
    <PersonaForm :dialog="isFormOpen" :personaData="selectedPersona" @close="isFormOpen = false" @saved="handlePersonaSaved" />
  </v-container>
</template>
